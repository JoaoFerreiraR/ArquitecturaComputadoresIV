.globl 	setpixel
.data
a0: .word   1 #COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
a1: .word   1#COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
a2: .word   0 #COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
a3: .word   0 #COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
sp: .word   255 #COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
...
setpixel:	
	##TESTE
		...
		la	$a3, a3	 #COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
		la	$sp, sp	 #COMENTAR LINHA SE FOR PARA USAR UM ENDEREÇO PASSADO A FUNCAO MESMO
	...
	la	$t0, 0x10010000 #endereço do display
